classdef (Abstract) opp_mode_interface
    ...
    methods
        ...
        function levels =  make_level_locs(obj, m, opts, lsupp_base, objective_mode, f, prefix)
            ...
            for n = 1:N
                ...
                for p = 1:P
                    ...
                    I_split = (opts.power_budget < Inf) && ~isempty(curr_lsupp.X);
        ...
        function imon = trig_occ_sign_monom(obj, d, signs)
            %moments of the occupation measure
            ...
            for n=1:N
                ...
                for p = 1:P
                    if ~isempty(obj.levels{n, p}.supp.X)                        
                        [~, mom_trig] = obj.levels{n, p}.trig_monom(d, signs);
                        imon{n} = imon{n} + mom_trig;
                    end
                end
            end
                end
