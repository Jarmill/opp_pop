...
Lload = 5e-3;
Rload = kappa * Lload;
sysload = 1/(s*Lload + Rload);
% sysload = s;
sys_c = sysload * sys;
% [yload, tload, xload] = lsim(sys_c, up, t);
% [yload, tload, xload] = lsim(sysload, yp, t);
[yload, tload, xload] = lsim(sysload, yp, t);
[yloadf, tloado, xloado] = lsim(sysload, yf, t);
% yload = cumsum(yp)./(t.*dt);
% yload(1) = 0;
